...
function ai() {
    ...
    /*async function detectObjects() {
        ...
        detections = predictions.filter(prediction => prediction.score >= confidenceThreshold);
    ...
    function updateDetectionList(predictions) {
        ...
        predictions.forEach((prediction, index) => {
            ...
            listItem.textContent = '${index + 1}. ${prediction.class} (${(prediction.score * 100).toFixed(2)}%)';
